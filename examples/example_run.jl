...
function parse_commandline()
    ...
    @add_arg_table s begin
        "--pos_path"
        default = "/home/astro/dforero/projects/desi-patchy/run/BOXpos%sOM0.315OL0.685G360V2000.0_ALPTrs6.000z1.100.dat"
        required = false
        "--vel_path"
        default = "/home/astro/dforero/projects/desi-patchy/run/VE%sEULz1.100.dat"
        required = false
        "--disp_path"
        default = "/home/astro/dforero/projects/desi-patchy/run/PSI%sz1.100.dat"
        required = false
        "--delta_path"
        default = "/home/astro/dforero/projects/desi-patchy/run/deltaBOXOM0.315OL0.685G360V2000.0_ALPTrs6.000z1.100.dat"
        required = false
        "--cweb_path"
        default = "/home/astro/dforero/projects/desi-patchy/run/TwebDelta_OM0.315OL0.685G360V2000.0z1.100.dat"
        required = false
        "--ref_catalog"
        ...
        "--params"
        default = [6.681508955504605, 5.47808573538, 0.7534895556587489, 1.1209400930989315, 0.10218062957157581]
        nargs = 5
        "--output_path"
        required = false
...
function fit_reference(args)
    ...
    if args["plot"]
        ...
        px = plot(s, s .^ 2 .* xi_ref, xscale = :log10, label = "Ref.", xlabel = L"s~[{\rm  Mpc}/h]", ylabel = L"s^2\xi(s)")
    end #if
    ...
    k, power_real, power_rsd, s, xi_rsd = full_model(params, subgrid_cat, collapsed_cat, do_collapse = true, compute_power = true, compute_xi = true)
    ...
    if args["plot"]
        ...
        px = plot!(px, s, s.^ 2 .* xi_rsd, label = "Coll,")
        ...
        savefig(final_plot, "plots/example_run.png")
    end #if
    ...
    res = optimize((pars,) -> loss(pars; train_power = false, train_xi = true), params, NelderMead(), Optim.Options(show_trace = true))
